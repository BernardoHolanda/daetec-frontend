...
<template>
  ...
  >
    ...
    <template v-else-if="nome === 'clientes'">
      <circle cx="9" cy="8" r="3.5" />
      <path d="M3 20a6 6 0 0112 0M17 11a3 3 0 100-6M18 20a5.5 5.5 0 00-2-4.3" />
    </template>
    <template v-else-if="nome === 'relatorio'">
    ...
    <template v-else-if="nome === 'recolher'">
      <path d="M6 9l6 6 6-6" />
    </template>
